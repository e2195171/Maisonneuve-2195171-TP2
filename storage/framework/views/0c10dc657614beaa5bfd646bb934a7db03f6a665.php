                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="home-tab">
                                <div class="control-group col-12">
                                    ...
                                    <input type="text" id="title" class="form-control" name="title_en" value="<?php echo e($forum->title); ?>">
                                </div>
                                <div class="control-group col-12 mt-2">
                                    <label for="body"><?php echo e(trans('lang.text_body_article')); ?></label>
                                    <textarea id="body" class="form-control" name="body_en"><?php echo e($forum->body); ?></textarea>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="french" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="control-group col-12">
                                    <label for="title"><?php echo e(trans('lang.text_title_article')); ?></label>
                                    <input type="text" id="title" class="form-control" name="title_fr" value="<?php echo e($forum->title); ?>">
                                </div>
                                <div class="control-group col-12 mt-2">
                                    <label for="body"><?php echo e(trans('lang.text_body_article')); ?></label>
                                    <textarea id="body" class="form-control" name="body_fr"><?php echo e($forum->body); ?></textarea>
                                </div>
                            </div>
                        </div>    
                        <div class="control-group col-12 mt-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Molson\Desktop\Maisonneuve-2195171 -local - Copie\resources\views/forum/edit.blade.php ENDPATH**/ ?>