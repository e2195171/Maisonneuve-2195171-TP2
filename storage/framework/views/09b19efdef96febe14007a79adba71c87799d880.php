            ...
            <div class="container">          
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link me-3 py-2 text-dark text-decoration-none" href="<?php echo e(route('directory')); ?>"><?php echo e(trans('lang.text_directory')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link me-3 py-2 text-dark text-decoration-none" href="<?php echo e(route('student')); ?>"><?php echo e(trans('lang.text_student')); ?></a>
                        </li>
                        <li class="nav-item">
...
</html><?php /**PATH C:\Users\Molson\Desktop\Maisonneuve-2195171 -local - Copie\resources\views/layouts/app.blade.php ENDPATH**/ ?>