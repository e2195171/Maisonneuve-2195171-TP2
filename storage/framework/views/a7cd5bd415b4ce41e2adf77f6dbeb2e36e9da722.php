    ...
    <div class="row">
        <div class="col-12 pt-2" style="min-height: 580px;">  
            ...
            <div class="mt-5 pl-4 pr-4 pb-4">
                ...
                <hr>
                <form novalidate action="<?php echo e(route('forum.create')); ?>" method="POST">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Molson\Desktop\Maisonneuve-2195171\resources\views/forum/create.blade.php ENDPATH**/ ?>